...
public class Practice0801Controller {
	...
	public String inputTemp(@ModelAttribute BodyTempForm bodyTempForm) {
	...
	public String showResult(@Valid @ModelAttribute("bodyTemp") BodyTempForm bodyTempForm, BindingResult result) {
		if (result.hasErrors()) {
			return "practice08/01/bt_input";
		}
		if ((35.0 < bodyTempForm.getBodyTemp()) && (bodyTempForm.getBodyTemp() < 37.5)) {
